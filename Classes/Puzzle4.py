...
plataforma_imagen.fill(pygame.Color(0,0,0,0))
...
def main():
    ...
    coords = [(200+350, 250+150), (200+350, 200+150), (200+350, 150+150),
              (250+350, 250+150), (250+350, 200+150), (250+350, 150+150),(250+350,100+150),(250+350,50+150),
    ...
    rectangle = pygame.rect.Rect(300, 350, 50, 50)
    rectangle2 = pygame.rect.Rect(300, 400, 50, 50)
    rectangle3 = pygame.rect.Rect(300, 450, 50, 50)
    rectangle4 = pygame.rect.Rect(350, 400, 50, 50)

    rectangle5 = pygame.rect.Rect(420, 250, 50, 50)
    rectangle6 = pygame.rect.Rect(470, 250, 50, 50)
    rectangle7 = pygame.rect.Rect(370, 300, 50, 50)
    rectangle8 = pygame.rect.Rect(420, 300, 50, 50)
    rectangle8_1 = pygame.rect.Rect(470,300, 50, 50)

    rectangle9 = pygame.rect.Rect(300, 150, 50, 50)
    rectangle10 = pygame.rect.Rect(300, 200, 50, 50)
    rectangle11 = pygame.rect.Rect(300, 250, 50, 50)
    ...
    while not hecho:
        for event in pygame.event.get():
            ...
            if event.type == pygame.QUIT:
                ...
                if event.button == 1:
                    ...
                    if (rectangle5.collidepoint(event.pos) or
                       ...
                       offset_x6 = offset_x5 + 50
                       offset_y6 = offset_y5
                       offset_x8 = offset_x5
                       offset_y8 = offset_y5 + 50
                       offset_x7 = offset_x8 - 50
                       offset_y7 = offset_y8
                       offset_x8_1 = offset_x8 + 50
                       offset_y8_1 = offset_y8
                    if (rectangle9.collidepoint(event.pos) or
                       rectangle10.collidepoint(event.pos) or
                       rectangle11.collidepoint(event.pos)):
            ...
            if (rectangle.x == 550 and rectangle.y == 300 and
                rectangle9.x == 600 and rectangle9.y == 200 and
                rectangle8_1.x == 700 and rectangle8_1.y == 400):
                hecho = True
        ...
        pygame.draw.rect(screen, (255, 255, 0), rectangle5)
        pygame.draw.rect(screen, (255, 255, 0), rectangle6)
        pygame.draw.rect(screen, (255, 255, 0), rectangle7)
        pygame.draw.rect(screen, (255, 255, 0), rectangle8)
        pygame.draw.rect(screen, (255, 255, 0), rectangle8_1)
        pygame.draw.rect(screen, (0, 255, 0), rectangle9)
        pygame.draw.rect(screen, (0, 255, 0), rectangle10)
        pygame.draw.rect(screen, (0, 255, 0), rectangle11)
        pygame.display.flip()
        clock.tick(30)

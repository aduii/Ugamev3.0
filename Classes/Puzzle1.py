...
def main():
    ...
    while not hecho:
        ...
        pygame.draw.rect(screen, (0, 0, 255), rectangle9)
        pygame.draw.rect(screen, (0, 0, 255), rectangle10)
        pygame.draw.rect(screen, (0, 0, 255), rectangle11)
        pygame.draw.rect(screen, (0, 0, 255), rectangle12)
        pygame.draw.rect(screen, (0, 255, 0), rectangle13)
        pygame.draw.rect(screen, (0, 255, 0), rectangle14)
        pygame.draw.rect(screen, (0, 255, 0), rectangle15)
        pygame.display.flip()
        clock.tick(30)
